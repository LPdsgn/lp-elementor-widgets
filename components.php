...
function register_breadcrumbs($widgets_manager) {
    require_once(get_stylesheet_directory() . '/components/breadcrumbs.php');
...
function register_scrollDownSpinner($widgets_manager) {
    require_once(get_stylesheet_directory() . '/components/scrollDownSpinner/scrollDownSpinner.php');
...
function register_scrollDownIndicator($widgets_manager) {
    require_once(get_stylesheet_directory() . '/components/scrollDownIndicator/scrollDownIndicator.php');
...
function registerStyle_scrollDownSpinner() {
    wp_register_style('scrollDown', get_stylesheet_directory_uri() . '/components/css/scrollDown.min.css');
