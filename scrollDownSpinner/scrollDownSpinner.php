...
?>
        <img decoding="async" class="looped-animation-rotate <?php echo esc_attr($color); ?>" height="<?php echo esc_attr($settings['dimension']); ?>" width="<?php echo esc_attr($settings['dimension']); ?>" src="<?php echo esc_url(lp_el_widets_base_uri() . '/scrollDownSpinner/scrollDownSpinner.png'); ?>" alt="Scroll to see more content">
<?php
    }
}
